  ...
  return (
    <div className="min-h-screen bg-sand-50 flex flex-col font-sans text-earth-900">
      ...
      <main className="flex-grow">
        ...
        <section className="py-24 px-6 md:px-12 bg-earth-900 text-sand-50 text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-serif mb-6">
              Get 5 Simple Daily Habits for Better Health
            </h2>
            <p className="text-sand-50/70 font-light mb-10 text-lg">
              Join our community and receive our free quick-start guide to natural wellness, delivered straight to your inbox.
            </p>
            <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
              ...
              <button 
                type="submit"
                className="px-8 py-4 font-medium text-earth-900 bg-sand-100 hover:bg-white rounded-full transition-colors whitespace-nowrap"
              >
                Send Me the Habits
              </button>
            </form>
